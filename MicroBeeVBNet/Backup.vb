...
'            'LOG_PROCESS.Item("AUTOMATION_STARTED") = LOGMESSAGE_AUTOMATION_STARTED
...
'            table.Rows.Add(25, "Juan", "David", DateTime.Now)
'            table.Rows.Add(50, "David", "Sam", DateTime.Now)
...
'            'trm = hc.GetAsync("https://jsonplaceholder.typicode.com/users")
'            'rm = trm.Result
...
'            '    Dim res As String
'            '    res = ts.Result
'            '    Dim JSONString = JsonConvert.SerializeObject(ts)
'            '    load_transaction_data = LOGMESSAGE_TRANSACTION_DATA_LOADED
'            '    'If res Then
'            '    '    '...work with result...
'            '    'Else
...
'    'Private Async Function GetJsonHttpClient(ByVal uri As String, ByVal httpClient As HttpClient) As Task(Of String)
'    '    Try
'    '        Return Await httpClient.GetFromJsonAsync(Of String)(uri)
'    '    Catch __unusedHttpRequestException1__ As HttpRequestException
'    '        Console.WriteLine("An error occurred.")
'    '    Catch __unusedNotSupportedException2__ As NotSupportedException
'    '        Console.WriteLine("The content type is not supported.")
'    '    Catch __unusedJsonException3__ As JsonException
